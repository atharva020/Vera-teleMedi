  ...
  ({ className, logo, slogan, title, subtitle, callToAction, backgroundImage, contactInfo }, ref) => {
    ...
    return (
      <motion.section
        ref={ref}
        className={cn(
          "relative flex w-full flex-col overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-slate-900 md:flex-row",
          className
        )}
        initial="hidden"
        animate="visible"
                    ...
                    {logo && (
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                {slogan && <p className="text-xs tracking-wider text-blue-600 font-medium">{slogan}</p>}
                            </div>
                        </div>
                    )}
                </motion.header>
